...
import org.mifos.mobile.Mifos-mobile-mobilePullToRefreshState
import org.mifos.mobile.mobile.core.designsystem.component.rememberMifos-mobilePullToRefreshState
import org.mifos.mobile.Mifos-mobile-mobilePoweredCard
import org.mifos.mobile.Mifos-mobile-mobileBottomBar
import org.mifos.mobile.Mifos-mobile-mobileNavigationRail

@OptIn(ExperimentalMaterial3Api::class, ExperimentalMaterial3WindowSizeClassApi::class)
@Suppress("LongMethod")
@Composable
fun Mifos-mobileScaffold(
    ...
    pullToRefreshState: Mifos-mobilePullToRefreshState = rememberMifos-mobilePullToRefreshState(),
...
private fun ScaffoldBottomAppBar(
    ...
    Box(modifier = modifier.fillMaxWidth()) {
        Column {
            Mifos-mobilePoweredCard(
                modifier = Modifier.fillMaxWidth(),
            )
            Mifos-mobileBottomBar(
